<?php
require_once("libraries/php-security-api/src/authentication/RememberMePersistenceDriver.php");
...
class RememberMePersistenceDriverWrapper extends PersistenceDriverWrapper {
	...
	protected function setDriver(SimpleXMLElement $xml) {
		$secret = (string) $xml->parameter;
		if(!$secret) throw new ServletApplicationException("'secret' key of security.persistence.remember_me tag is mandatory!");
